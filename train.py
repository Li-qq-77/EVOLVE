...
from cutie.dataset.setup_training_data import setup_pre_training_datasets, setup_main_training_datasets, setup_main_training_event_dataset
...
def train(cfg: DictConfig):
    ...
    for stage in stages:
        ...
        if stage == 'pre_training':
            ...
            dataset, sampler, loader = setup_main_training_event_dataset(cfg, max_skip_schedule[0])
        ...
        try:
            ...
            while curr_iter < total_iterations:
                ...
                for data in loader:
                    ...
                    if curr_iter >= change_skip_iter[0]:
                        ...
                        _, sampler, loader = setup_main_training_event_dataset(cfg, cur_skip)
                        break
            ...
            if not cfg.debug:
                trainer.save_weights(curr_iter,save_copy=True)
                trainer.save_checkpoint(curr_iter,save_copy=True)
